  ...
  return (
    <div className="space-y-4" data-testid="outlet-detail-page">
      ...
      >
        ...
        {photo ? "Foto Siap" : "Ambil Foto Check-in (Opsional)"}
      </button>
      <input
        ref={fileRef}
        type="file"
        ...
        onChange={onPhoto}
      />
      {photo && <img src={photo} alt="Foto kunjungan" className="w-full h-36 object-cover rounded-xl border border-slate-200" />}
