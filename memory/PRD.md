...
Enterprise Distribution Management System (DMS Mahameru) untuk PT Mahameru Insan Mandiri. Mobile-first field ops (absensi GPS, kunjungan outlet, hybrid call plan, transaksi lapangan, effective/open call), monitoring supervisor + peta, master data admin, dashboard owner + report center, inventory gudang, offline mode + sync, audit trail. Bahasa Indonesia. Branding navy #0A2540 + gold #C5A059, font Outfit/Manrope.
